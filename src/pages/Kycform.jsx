    ...
    return <section className="bg-blue-100 w-screen p-5">
        ...
        <form action="" className="bg-white  lg:w-[65%] py-4 mx-auto my-12 border">
            ...
            <div className="px-4 lg:px-12 pt-6">
                <p className="text-gray-500 border-l-4 pl-3">Please type carefully and fill out the form with your personal details. Your can’t edit these details once you submitted the form.</p>

                <div className="mt-6 -mb-12 ">
                    <div className="lg:flex md:flex justify-between">
                        <InputPrimary field={'First name'} name={'firstName'} placeholder={'John'} />
                        <InputPrimary field={'Last name'} name={'lastName'} placeholder={'Smith'} />
                    </div>
                    
                    <div className="lg:flex md:flex justify-between">
                        <InputPrimary field={'Email address'} name={'email'} placeholder={'you@example.com'} />
                    ...
                    <div className="lg:flex md:flex justify-between">
                        ...
                        <InputPrimary field={'Telegram username'} name={'telegramUsername'} placeholder={' '} />
                    </div>
                    ...
                    <div className="mt-3">
                        ...
                        <div className="lg:flex md:flex justify-between">
                            ...
                            <InputPrimary field={'Address line 2'} name={'address2'} placeholder={' '} />
                        </div>

                        <div className="lg:flex md:flex justify-between">
                            <InputPrimary field={'City'} name={'city'} placeholder={' '} />
                            <InputPrimary field={'State'} name={'state'} placeholder={' '} />
                        </div>

                        <div className="lg:flex md:flex justify-between">
                            <InputPrimary field={'Nationality'} name={'nationality'} placeholder={' '} />
                            <InputPrimary field={'Zip Code'} name={'zipCode'} placeholder={' '} />
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="px-4 lg:px-12 px-6 py-6">
                <p className="text-gray-500 border-l-4 pl-3">In order to complete, please upload any of the following personal document.</p>

                <div className="lg:flex md:flex justify-between mt-3">
                    <InputPrimary type={'file'} field={'Passport'} name={'passport'} placeholder={' '} />
                    <InputPrimary type={'file'} field={'National card'} name={'nationalCard'} placeholder={' '} />
                    <InputPrimary type={'file'} field={'Driver\'s license'} name={'driverLicense'} placeholder={' '} />
                </div>
                ...
                <div className="my-4">
                    ...
                    <p className="my-1 text-gray-800">Make sure that there is no light glare on the card.</p>
                </div>
            </div>
            ...
            <div className="px-12 pt-3">
                <div className="lg:flex md:flex flex-col justify-between">
                    ...
                    <InputPrimary field={'Your address for token'} name={'walletAddress'} placeholder={' '} />
                </div>
            </div>

            <div className="flex lg:px-12 py-3 lg:w-[65%] justify-center mx-2">
            <input type="checkbox" name={'privacyPolicy'} className='' />
            <label htmlFor="privacyPolicy" className="mx-3">I Have Read The Terms Of Condition And Privary Policy.</label>
            </div>

            <div className="flex lg:px-12 lg:w-[65%] justify-center mx-2">
            <input type="checkbox" name={'isCorrect'} className='' />
            <label htmlFor="isCorrect" className="mx-3">All The Personal Information I Have Entered Is Correct.</label>
            </div>
